...
/**
 * Tooltip showing the mean plus how complete the bucket is. Coverage =
 * observed/expected hours, which lets the reader discount a mean that's built
 * from only a handful of the period's hours.
 */
