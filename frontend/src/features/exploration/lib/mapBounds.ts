...
/**
 * Bounding box for maplibregl fitBounds from stroke coordinates. The minSpanDeg
 * floor stops a single point (or tightly clustered strokes) from fitting to an
 * absurd zoom level — without it the map would slam to max zoom on one stroke.
 */
