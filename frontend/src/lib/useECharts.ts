 ...
 *
 * `structureKey` identifies a new chart context (history span + granularity). Location
 * and display changes patch series and axes while translating the user's calendar zoom.
 */
